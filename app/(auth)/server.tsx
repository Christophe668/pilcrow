...
export default function ServerScreen() {
  ...
  // When the deployment is configured with a same-origin proxy
  // (`PILCROW_BACKEND_URL` on the container), the operator has already
  // picked a backend — the user just needs to confirm. Pre-fill the
  // URL field with the current origin so submitting Continue routes
  // through the same-origin proxy to the configured backend.
  useEffect(() => {
    let cancelled = false;
